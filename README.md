...
![image-20230709110308018](F:\PAT\image-20230709110308018.png)
...
> **注**：MAX值是一个标志值，这里的作用是用来标注空间是空闲的。因为有些题目会规定每个元素的大小，这个MAX值一般是比所有规定值都大的，可以用来做标志位。
